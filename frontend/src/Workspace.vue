            ...
            <div class="admin-shell">
              ...
              <div class="admin-grid">
                <div class="admin-card">
                  ...
                  >
                    ...
                    <el-table-column label="操作" width="120" fixed="right">
                      <template #default="{ row }">
                        <el-button link type="primary" @click.stop="selectAdminUser(row.id)">查看</el-button>
                        <el-button link type="danger" @click.stop="handleDeleteAdminUser(row)">删除</el-button>
                      </template>
                    </el-table-column>
                  </el-table>
                </div>
                ...
                <div class="admin-card">
                  <div class="card-title-row">
                    <h3>
                      {{ adminUser ? `${adminUser.username} 的文件` : '请选择一个用户' }}
                    </h3>
